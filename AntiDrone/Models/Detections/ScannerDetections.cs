...
public class ScannerDetections
{
    ...
    public string port { get; set; } /* 탐지 데이터 코드 */
    public long sc_det_id { get; set; } /* 스캐너 탐지체 고유 식별 id */
    public long model { get; set; } /* 탐지 드론 모델명 */
    ...
    public double operator_lat { get; set; } /* 조종자 좌표(위도) */
    public double operator_lon { get; set; } /* 조종자 좌표(경도) */
    ...
    public TimeOnly det_time { get; set; } /* 탐지 시작 시각 */
}